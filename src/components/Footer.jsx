            ...
            <div className="container">
                <Grid col={4} mdCol={2} smCol={1} gap={10}>
                    ...
                    <div className="footer__about">
                        <p><Link to="/">
                            <img src={logo} alt="" className="footer__logo" /></Link></p>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod, veniam maxime deserunt placeat quaerat quasi?</p>
                    </div>
                </Grid>
            </div>
        </footer>
